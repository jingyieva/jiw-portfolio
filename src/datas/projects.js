export const projects = [
    {
        title: '二手交易分析儀表板',
        description: 'React + Tailwind + Recharts，含 ChartContainer、Bar/Pie/Line 範例與單元測試。',
        tags: ['React', 'Tailwind', 'Recharts', 'Testing'],
        demo: 'https://2nd-track-dashboard.vercel.app',
        repo: 'https://github.com/jingyieva/2nd_track_dashboard',
    },
    {
